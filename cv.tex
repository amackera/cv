...
\begin{center}
    \textbf{\Huge \scshape Anson MacKeracher} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:16475237592}{+1 647 523 7592}
    $|$
    \faAt \hspace{.5pt} \href{mailto:anson@mackeracher.com}{anson@mackeracher.com}
    $|$
    \faLinkedinSquare \hspace{.5pt} \href{https://www.linkedin.com/in/amackera}{LinkedIn}
    $|$
    \faGithub \hspace{.5pt} \href{https://github.com/amackera}{GitHub}
%%     $|$
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {B.Sc. in Computer Engineering}{Sep 2005 \textbf{--} May 2010}
        % \resumeItemListStart
