...
\usepackage[
    pdftitle={Anson MacKeracher's CV},
    pdfauthor={Anson MacKeracher},
...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:anson@mackeracher.com}{anson@mackeracher.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+1 (647) 523-7592}{+1 (647) 523-7592}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://mackeracher.com/}{mackeracher.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/amackera}{linkedin.com/in/amackera}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/amackera}{github.com/amackera}}%
    \end{header}
